  ...
  return (
    ...
    >
      ...
      <dl className="mt-6 border-y border-slate-800 py-4">
        <div>
          <dt className="text-xs uppercase tracking-[0.14em] text-slate-500">Categoría</dt>
          <dd className="mt-1 text-sm font-medium text-slate-200">{exercise.category}</dd>
        </div>
      </dl>

      <p className="mt-5 flex-1 text-sm leading-6 text-slate-300">{exercise.description}</p>
    </article>
  )
}
